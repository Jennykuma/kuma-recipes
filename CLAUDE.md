...
- Client routing: `apps/web/src/routes.tsx`
...
- Shared recipe view (public): `apps/web/src/pages/RecipeDetails/SharedRecipeDetails.tsx`
- R&D Lab tab: `apps/web/src/pages/RecipeLab/RDLabTab.tsx`
...
- Lab API routes: `apps/api/src/routes/lab.routes.ts`
- AI API routes: `apps/api/src/routes/ai.routes.ts`
