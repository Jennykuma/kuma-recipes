...
const stylesByVariant = {
    loading: {
        panel: 'border-blush-100/80 bg-[linear-gradient(145deg,rgba(255,249,251,0.96),rgba(246,251,248,0.96))] dark:border-gray-700 dark:bg-[#2a2a2a]',
        badge: 'border-blush-100 bg-white/90 text-blush-400 dark:border-gray-600 dark:bg-[#232323]',
        eyebrow: 'text-blush-500/80 dark:text-blush-300',
        role: 'status' as const,
        live: 'polite' as const,
    },
    error: {
        panel: 'border-rose-100/80 bg-[linear-gradient(145deg,rgba(255,247,248,0.97),rgba(255,252,249,0.95))] dark:border-gray-700 dark:bg-[#2a2a2a]',
        badge: 'border-rose-100 bg-white/90 text-rose-500 dark:border-gray-600 dark:bg-[#232323]',
