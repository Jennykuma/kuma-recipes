...
const TagsSection = ({ tags, isEditing, onEdit, onSave, onCancel }: TagsSectionProps) => {
    ...
    return (
        <div className="w-full">
            <div className="flex flex-row items-baseline gap-1 mb-1 text-xs text-gray-600 dark:text-gray-300">
                <span className="inline-flex items-center gap-1 uppercase tracking-wide rounded-full">
